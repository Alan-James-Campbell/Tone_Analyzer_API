...
app
  .use(express.static(path.join(__dirname, '/client/public'))) // Serve the static files from the React app
  ...
  .get('*', (req,res) => res.sendFile(path.join(__dirname+'/client/public/index.html')))  // Handles unknown requests
